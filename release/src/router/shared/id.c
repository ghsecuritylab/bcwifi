 ...
 * Tenda N60
 ...
 boardtype=0x052B
 boardpwrctl=0xD00
 boardflags2=0x00089000
 sb/1/boardflags2=0x00089000
 0:boardtype=0x052A
 sb/1/boardflags=0x00000710
 0:boardvendor=0x14e4
 0:boardrev=0x1107
 0:boardflags=0x00000400
...
*/
	...
	case 80:
		switch (hw) {
			case HW_BCM5300:
				if (nvram_match("boardrev", "0x1200"))
				{
					return MODEL_X3;
				}else if (nvram_match("boardrev", "0x1104"))
				{
					return MODEL_X5;
				}
		}
	...
	case 1:
		...
		case HW_BCM5357:
			/*
			   ...
			   sdram_config=0x3
			 */
			if (nvram_match("boardrev", "0x1153") && nvram_match("sdram_config","0x3")) return MODEL_235W;
			/*
			   boardflags2=0x1000
			   boardflags=0x710
			   boardnum=1
			   ...
			   sdram_config=0x103
			   */
			if (nvram_match("boardrev", "0x1153") && nvram_match("sdram_config","0x103")) return MODEL_NW736;
	...
	case 1015:	
		/*
			...
			sb/1/boardflags=0x71
		*/
		if (nvram_match("boardrev", "0x1100") && nvram_match("boardflags","0x710")) return MODEL_520W;
		break;
	case 0543:
		switch (hw) {
		case HW_BCM5357:
			//if (nvram_match("boardrev", "0x1202"))
			if (nvram_match("boardrev", "0x1441"))
                return MODEL_NW755;
			return MODEL_H218N;
		}
		break;
