...
<div class='section-title'>IPv4端口转发</div>
<div class='section'>
	<table 

class='table table-bordered table-striped' cellspacing=1 id='fo-grid'></table>
	<script type='text/javascript'>fog.setup();</script>
</div>

<div>
<ul>
<li><b>源地址</b> <i>(可选)</i> - 仅映射该地址的连接. 例: "1.2.3.4", "1.2.3.4 - 2.3.4.5", "1.2.3.0/24".
</li><li><b>外部端口</b> - 从WAN对应进来的端口. 例: "2345", "200,300", "200-300,400".
</li><li><b>内部端口</b> <i>(可选)</i> -  .若为空, 便自动对应 <i>外部端口</i>.
当内部端口与外部端口范围不同时,才须填入内部端口.
</li><li><b>内部地址</b> - 对应局域网络内的IP地址.
</li></ul>
</div>
