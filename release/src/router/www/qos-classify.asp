...
var ipp2p = [
	[0,'IPP2P (禁用)'],[0xFFF,'所有'],[1,'AppleJuice'],[2,'Ares'],[4,'BitTorrent'],[8,'Direct Connect'],
...
function v_dscp(e, quiet)
{
	...
	if ((!v.match(/^ *(0x)?[0-9A-Fa-f]+ *$/)) || (v < 0) || (v > 63)) {
		ferror.set(e, '无效的DSCP值. 有效范围: 0x00-0x3F', quiet);
		return 0;
	}
...
class='table table-bordered table-striped' cellspacing=1 id='qg'></table>
</div>

<br>
<script type='text/javascript'>
if (nvram.qos_enable != '1') {
	W('<div class="note-disabled"><b>QoS 停用.</b> &nbsp; <a href="qos-settings.asp">启用 &raquo;</a></div>');
}
else {
