...
createFieldTable('', [
	...
	{ title: '事件记录', text: '<small>(某些改动在重启后生效)</small>' },
		...
		{ title: '记录计划事件', indent: 2, name: 'f_log_crond', type: 'checkbox', value: (nvram.log_events.indexOf('crond') != -1) },
		{ title: '记录DHCP客户端事件', indent: 2, name: 'f_log_dhcpc', type: 'checkbox', value: (nvram.log_events.indexOf('dhcpc') != -1) },
...
createFieldTable('', [
	...
	{ title: '监测范围(局域网电脑)', name: 'log_wmtype', type: 'select', options: [[0,'所有电脑/设备'],[1,'下列电脑/设备'],[2,'除下列电脑/设备之外...']], value: nvram.log_wmtype },
		{ title: 'IP 地址', indent: 2,  name: 'f_log_wmip', type: 'text', maxlen: 512, size: 64, value: nvram.log_wmip,
