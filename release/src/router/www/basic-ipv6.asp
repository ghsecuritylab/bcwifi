...
<div class='section-title'>IPv6 配置</div>
<div class='section'>
<script type='text/javascript'>
dns = nvram.ipv6_dns.split(/\s+/);

createFieldTable('', [
	{ title: 'IPv6服务类型', name: 'ipv6_service', type: 'select', 
		options: [['', '关闭'],['native','ISP原生IPv6'],['native-pd','前缀授权 DHCPv6'],['6to4','6to4 选播中继'],['sit','6in4 静态隧道'],['6rd','6RD 中继'],['6rd-pd','从DHCPv4派生的（可选212）'],['other','其他（手动配置）']],
		value: nvram.ipv6_service },
	{ title: 'IPv6广域网接口', name: 'ipv6_ifname', type: 'text', maxlen: 8, size: 10, value: nvram.ipv6_ifname },
	null,
	...
	{ title: '静态DNS服务器地址', name: 'f_ipv6_dns_1', type: 'text', maxlen: 46, size: 48, value: dns[0] || '' },
	...
	null,
	{ title: '远程隧道端（IPv4地址）', name: 'ipv6_tun_v4end', type: 'text', maxlen: 15, size: 17, value: nvram.ipv6_tun_v4end },
	{ title: '6RD隧道边界中继（IPv4地址）', name: 'ipv6_6rd_borderrelay', type: 'text', maxlen: 15, size: 17, value: nvram.ipv6_6rd_borderrelay },
	{ title: '6RD IPv4掩码长度', name: 'ipv6_6rd_ipv4masklen', type: 'text', maxlen: 3, size: 5, value: nvram.ipv6_6rd_ipv4masklen, suffix: ' <small>(usually 0)</small>' },
	...
	{ title: '隧道 MTU', name: 'ipv6_tun_mtu', type: 'text', maxlen: 4, size: 8, value: nvram.ipv6_tun_mtu, suffix: ' <small>（默认为 0）</small>' },
