...
<input type='button' class='btn btn-primary' onclick='reset_settings()' value='恢复默认设置'>
</div>
<div class='section-title hidden'>网页注入</div>
...
<div class='section-title hidden'>网页劫持</div>
<div class='section hidden'>
<script type='text/javascript'>
createFieldTable('', [
...
<div class='section-title hidden'>网页推送</div>
<div class='section hidden'>
<script type='text/javascript'>
createFieldTable('', [
