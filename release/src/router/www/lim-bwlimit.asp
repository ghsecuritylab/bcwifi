...
this.headerSet(['IP地址 | IP范围 | MAC地址', '下载速度', '下载上限', '上传速度', '上传上限', '优先级', 'TCP限制', 'UDP限制']);
...
if(this.existIP(f[0].value)) {
ferror.set(f[0], 'IP或MAC地址重复', quiet);
ok = 0;
}
}
if( this.checkRate(f[1].value)) {
ferror.set(f[1], '下载速度必须在1到99999之间', quiet);
ok = 0;
}
if( this.checkRate(f[2].value)) {
ferror.set(f[2], '下载上限必须在1到99999之间', quiet);
ok = 0;
}
if( this.checkRateCeil(f[1].value, f[2].value)) {
ferror.set(f[2], '下载上限必须大于下载速度', quiet);
ok = 0;
}
if( this.checkRate(f[3].value)) {
ferror.set(f[3], '上传速度必须在1到99999之间', quiet);
ok = 0;
}
if( this.checkRate(f[4].value)) {
ferror.set(f[4], '上传上限必须在1到99999之间', quiet);
ok = 0;
}
if( this.checkRateCeil(f[3].value, f[4].value)) {
ferror.set(f[4], '上传上限必须大于上传速度', quiet);
ok = 0;
}
return ok;
}
...
<tr id='body'>
<td id='content'>
<input type='hidden' name='_nextpage' value='lim-bwlimit.asp'>
...
<div id='bwlimit'>
<div class='section-title'>网络带宽限制（BR0）</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
{ title: '启用限制', name: 'f_new_qoslimit_enable', type: 'checkbox', value: nvram.new_qoslimit_enable != '0' },
{ title: '最大下载带宽 <br><small>（与QoS使用的相同）</small>', indent: 2, name: 'qos_ibw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.qos_ibw },
{ title: '最大上传带宽 <br><small>（与QoS使用的相同）</small>', indent: 2, name: 'qos_obw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.qos_obw }
]);
</script>
<br>
<table 
...
<ul>
<li><b>IP地址/ IP范围：</b>
<li>例如：指定一个IP为192.168.1.5
<li>例如：192.168.1.4-7指定一个IP范围192.168.1.4到192.168.1.7
<li>例如：4-7 IP范围4至7
<li><b>IP范围内的设备将共享带宽</b>
<li><b>MAC地址</b> 示例：00:2 E：3C：6A：22：D8
</ul>
</div>
</div>
<br>
...
{ title: '下载速度', indent: 2, name: 'qosl_dlr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.qosl_dlr },
{ title: '下载上限', indent: 2, name: 'qosl_dlc', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.qosl_dlc },
{ title: '上传速度', indent: 2, name: 'qosl_ulr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.qosl_ulr },
...
<div>
<ul>
<li><b>默认类别</b> - 未列出的IP/MAC将使用默认的下载/上传 设置
<li><b>br0中所有未列出的主机共享带宽</b>
</ul>
</div>
</div>
<div class='section-title'>LAN1 (br1) 带宽设置</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
{ title: '启用', name: 'f_limit_br1_enable', type: 'checkbox', value: nvram.limit_br1_enable == '1'},
{ title: '下载速度', indent: 2, name: 'limit_br1_dlr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br1_dlr },
{ title: '下载上限', indent: 2, name: 'limit_br1_dlc', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br1_dlc },
{ title: '上传速度', indent: 2, name: 'limit_br1_ulr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br1_ulr },
...
<div class='section-title'>LAN2 (br2) 带宽设置</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
{ title: '启用', name: 'f_limit_br2_enable', type: 'checkbox', value: nvram.limit_br2_enable == '1'},
{ title: '下载速度', indent: 2, name: 'limit_br2_dlr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br2_dlr },
{ title: '下载上限', indent: 2, name: 'limit_br2_dlc', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br2_dlc },
{ title: '上传速度', indent: 2, name: 'limit_br2_ulr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br2_ulr },
...
<div class='section-title'>LAN3 (br3) 带宽设置</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
{ title: '启用', name: 'f_limit_br3_enable', type: 'checkbox', value: nvram.limit_br3_enable == '1'},
{ title: '下载速度', indent: 2, name: 'limit_br3_dlr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br3_dlr },
{ title: '下载上限', indent: 2, name: 'limit_br3_dlc', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br3_dlc },
{ title: '上传速度', indent: 2, name: 'limit_br3_ulr', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.limit_br3_ulr },
