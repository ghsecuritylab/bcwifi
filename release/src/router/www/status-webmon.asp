...
dg.setup = function() {
	...
	this.headerSet(['最后访问时间', '源IP 地址', '目标域名']);
	this.sort(0);
}
...
class='table table-bordered table-striped' style="float:left" cellspacing=1></table>
	...
	<div id='webmon-controls'>
		<div id='webmon-mc'>
			显示 &nbsp;
			<a href='javascript:switchMaxCount(10);' id='mc10'>10条,</a>
			<a href='javascript:switchMaxCount(50);' id='mc50'>50条,</a>
			<a href='javascript:switchMaxCount(100);' id='mc100'>100条,</a>
			<a href='javascript:switchMaxCount(200);' id='mc200'>200条,</a>
			<a href='javascript:switchMaxCount(500);' id='mc500'>500条,</a>
			<a href='javascript:switchMaxCount(1000);' id='mc1000'>1000条,</a>
			<a href='javascript:switchMaxCount(2000);' id='mc2000'>2000条,</a>
			<a href='javascript:switchMaxCount(5000);' id='mc5000'>5000条,</a>
