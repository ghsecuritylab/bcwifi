...
<div class='section-title'>PPTP 服务配置</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
	{ title: '启用', name: 'f_pptpd_enable', type: 'checkbox', value: nvram.pptpd_enable == '1' },
	{ title: '本地IP / 子网掩码', text: (nvram.lan_ipaddr + ' / ' + nvram.lan_netmask) },
	...
	{ title: '广播中继模式', name: 'pptpd_broadcast', type: 'select', options: [['disable','禁用'], ['br0','LAN 到 VPN客户端'], ['ppp','VPN客户端 到 LAN'], ['br0ppp','全部']], value: nvram.pptpd_broadcast },
	...
	{ title: 'MTU设置', name: 'pptpd_mtu', type: 'text', maxlen: 4, size: 6, value: (nvram.pptpd_mtu ? nvram.pptpd_mtu : 1450)},
...
class='table table-bordered table-striped' cellspacing=1 id='ul-grid'></table>
</div>

<div class='section-title'>说明 <small><i><a href='javascript:toggleVisibility("notes");'><span id='sesdiv_notes_showhide'>（点击这里显示）</span></a></i></small></div>
<div class='section' id='sesdiv_notes' style='display:none'>
<ul>
<li><b>本地IP地址/子网掩码</b> - 此地址用于连接VPN服务端和客户端的PPP隧道。</li>
<li><b>远程IP地址池</b> - 远程IP地址用于PPP隧道连接（最大支持6个）。</li>
<li><b>广播中继模式</b> - 在VPN客户端和LAN接口之间启用广播中继。</li>
<li><b>启用加密</b> - 启用此选项将要打开VPN隧道加密功能，但是这可能加大隧道的带宽占用率。</li>
<li><b>DNS服务</b> - 允许手动配置DNS服务（如果置空，VPN客户端则默认使用路由本地虚拟IP地址作为DNS服务地址）。</li>
<li><b>WINS服务</b> - 允许对VPN客户端配置额外的WINS服务，添加的WINS服务基于<a href=basic-network.asp>基础/网络</a>。</li>
<li><b>MTU</b> - 最大传输单元，PPTP接口在不将数据包切片所能传输的最大包值。</li>
<li><b>MRU</b> - 最大接收单元，PPTP接口在不将数据包切片所能接收到的最大包值。</li>
</ul>
...
<li><b>其它相关说明/建议：</b>
<ul>
<li>配置时避免PPTP地址池范围和本地局域网网段或者DHCP地址池范围相同。</li>
</ul>
</small>
</div>
...
&raquo; <a href="vpn-pptp-online.asp">PPTP在线</a>
</div>
