...
<div class='section-title'>NFS 服务</div>
<div class='section'>
	<script type='text/javascript'>
	createFieldTable('', [
...
<br>
	<ul>
	<li>您能够在这个网站下找到特定的NFS配置信息： <a href="http://nfs.sourceforge.net/nfs-howto/" target="_blanc"><b>http://nfs.sourceforge.net</b></a>.
	</ul>
<br>
</div>
...
<div class='section-title'>NFS客户端</div>
<div class='section'>
<br>
	<ul>
	<li>如果您需要从其它NFS服务器上挂载一个NFS共享，您可以使用例如telnet/ssh等相关工具。
	</ul>
</div>
