...
function tick()
{
	if (--n > 0) {
		...
		document.getElementById('msg').innerHTML = '您现在可以拔除路由器电源.';
	}
}
</script></head>
...
<span id='msg'>请耐心等待! 直到路由器关机... <span id='sptime' style='font-size:80%;background:#eee'></span></span>
</td></tr>
</table></body></html>
