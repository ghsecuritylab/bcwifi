...
<title>[<% ident(); %>] 系统管理：CIFS客户端</title>
...
<div class='section-title'>CIFS 客户端设置</div>
<div class='section'>
<script type='text/javascript'>
...
createFieldTable('', [
	...
	{ title: '计算机名', indent: 2, name: 'f_cifs1_servern', type: 'text', maxlen: 128, size: 64, value: a[6] },
	...
	{ title: '安全设置', indent: 2, name: 'f_cifs1_sec', type: 'select',
		options: [['','Default (NTLM)'],['ntlmi','NTLM and packet signing'],['ntlmv2','NTLMv2'],['ntlmv2i','NTLMv2 and packet signing'],['nontlm','No NTLM'],['lanman','LANMAN'],['none','无']],
		value: a[7] },
	...
	{ title: '计算机名', indent: 2, name: 'f_cifs2_servern', type: 'text', maxlen: 128, size: 64, value: b[6] },
