...
createFieldTable('', [
	...
	{ title: '路由跟踪', indent: 2, name: 'f_icmp_limit_traceroute', type: 'text', maxlen: 3, size: 3, suffix: ' <small> 每秒响应次数</small>', value: fixInt(nvram.block_wan_limit_tr || 5, 1, 300, 5) },
	null,
	{ title: '启用SYN Cookies', name: 'f_syncookies', type: 'checkbox', value: nvram.ne_syncookies != '0' }
]);
</script>
</div>
...
<script type='text/javascript'>
createFieldTable('', [
	{ title: 'NAT回环', name: 'nf_loopback', type: 'select', options: [[0,'所有'],[1,'仅前转'],[2,'关闭']], value: fixInt(nvram.nf_loopback, 0, 2, 1) },
	{ title: 'NAT目标', name: 'ne_snat', type: 'select', options: [[0,'MASQUERADE'],[1,'SNAT']], value: nvram.ne_snat }
]);
</script>
</div>

<div class='section-title'>组播设置</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
	{ title: '允许IGMPproxy', name: 'f_multicast', type: 'checkbox', value: nvram.multicast_pass == '1' },
