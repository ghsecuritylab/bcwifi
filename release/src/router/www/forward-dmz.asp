...
<div class='section-title'>设置DMZ</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
	{ title: '启用DMZ', name: 'f_dmz_enable', type: 'checkbox', value: (nvram.dmz_enable == '1') },
	...
	{ title: '源地址限制', indent: 2, name: 'f_dmz_sip', type: 'text', maxlen: 512, size: 64,
		value: nvram.dmz_sip, suffix: '<br><small>(可选的，例如：“1.1.1.1”，“1.1.1.0/24”，“1.1.1.1 - 2.2.2.2”或“me.example.com”)</small>' },
	null,
	{ title: '远程访问例外', indent: 2, name: 'f_dmz_ra', type: 'checkbox', value: (nvram.dmz_ra == '1'), suffix: ' &nbsp;<small>(SSH和HTTP（S）到路由器的远程访问端口重定向)</small>' }
]);
</script>
</div>
