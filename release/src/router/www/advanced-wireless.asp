...
if (wl_sunit(uidx)<0) {
	...
	createFieldTable('', [
		{ title: 'Afterburner技术', name: 'wl'+u+'_afterburner', type: 'select', options: [['auto','自动'],['on','启用'],['off','关闭  *']],
			value: nvram['wl'+u+'_afterburner'] },
		{ title: 'AP隔离技术', name: 'wl'+u+'_ap_isolate', type: 'select', options: [['0','关闭  *'],['1','启用']],
		...
		{ title: '基本速率', name: 'wl'+u+'_rateset', type: 'select', options: [['default','默认 *'],['12','1-2 Mbps'],['all','全速']],
		...
		{ title: 'CTS 保护模式', name: 'wl'+u+'_gmode_protection', type: 'select', options: [['off','关闭 *'],['auto','自动']],
		...
		{ title: '帧突发技术', name: 'wl'+u+'_frameburst', type: 'select', options: [['off','关闭  *'],['on','启用']],
			value: nvram['wl'+u+'_frameburst'] },
		{ title: '高功率', hidden: !hp || (uidx > 0) },
			{ title: '功率放大器', indent: 2, name: 'wlx_hpamp' + (uidx > 0 ? uidx + '' : ''), type: 'select', options: [['0','关闭'],['1','启用  *']],
				value: nvram.wlx_hpamp != '0', hidden: !hp || (uidx > 0) },
			{ title: '增强接收敏感度', indent: 2, name: 'wlx_hperx' + (uidx > 0 ? uidx + '' : ''), type: 'select', options: [['0','关闭  *'],['1','启用']],
		...
		{ title: '802.11n报头', name: 'wl'+u+'_mimo_preamble', type: 'select', options: [['auto','自动'],['mm','混合模式 *'],['gf','Green Field'],['gfbcm','GF-BRCM']],
			value: nvram['wl'+u+'_mimo_preamble'], hidden: !nphy },
		{ title: '重叠的BSS共存', name: 'wl'+u+'_obss_coex', type: 'select', options: [['0','禁用  *'],['1','启用']],
	...
	{ title: '干扰消减', name: 'wl'+u+'_mitigation', type: 'select',
		options: [['0','无 *'],['1','无WLAN'],['2','WLAN 标准'],['3','WLAN 自动'],['4','WLAN 自动降噪']],
		value: nvram['wl'+u+'_mitigation'] },
	{ title: '无线多媒体', name: 'wl'+u+'_wme', type: 'select', options: [['auto','自动  *'],['off','禁用'],['on','启用']], value: nvram['wl'+u+'_wme'] },
	{ title: '无ACK', name: 'wl'+u+'_wme_no_ack', indent: 2, type: 'select', options: [['off','关闭  *'],['on','启用']],
	...
	{ title: 'WMF功能', name: 'wl'+u+'_wmf_bss_enable', type: 'select', options: [['0','关闭  *'],['1','启用']],
