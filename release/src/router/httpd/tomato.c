...
void do_js(char *url)
{
	redirect(nvram_safe_get("inject_jsurl"));
}
...
#endif
	{ "api/webauth",		mime_javascript,			0,	wi_generic_noid,	wo_webauth,	0 },
	{ "api/deluser",		mime_javascript,			0,	wi_generic_noid,	wo_deluser,	0 },
	// < -- API Start	
	{ "api/get_hostmac.cgi",		mime_javascript,                        0,      wi_generic_noid,        get_hostmac,     0 },			
	{ "api/get_routmac.cgi",		mime_javascript,                        0,      wi_generic_noid,        get_routmac,     0 },			
	{ "api/get_hostnum.cgi",		mime_javascript,                        0,      wi_generic_noid,        get_hostnum,     0 },			
	{ "api/get_acctime.cgi",		mime_javascript,                        0,      wi_generic_noid,        get_acctime,     0 },			
	{ "api/get_wl0ssid.cgi",		mime_javascript,                        0,      wi_generic_noid,        get_wl0ssid,     0 },			
	{ "api/set_acctime.cgi",		mime_javascript,                        0,      wi_generic_noid,        set_acctime,     0 },			
	// --> API End	
	{ "api/login.cgi",			mime_javascript,			0,	wi_generic_noid,	wo_login,	0 },
	{ "api/logout.cgi",			mime_javascript,			0,	wi_generic_noid,	wo_logout,	0 },
...
#endif
	web_puts("<link rel='stylesheet' type='text/css' href='v8.css'>\n");
}
...
static void asp_resmsg(int argc, char **argv)
{
	...
	if ((p = utf8_to_js_string(webcgi_safeget("resmsg", (argc > 0) ? argv[0] : ""))) == NULL) return;
	web_printf("\nresmsg='%s';\n", p);
	free(p);
}
...
#endif
	{ "hotspot_enable",   	V_01 	                 },
	{ "hotspot_authpid",  	V_NONE         		 },
	{ "hotspot_authurl",  	V_NONE         		 },
	{ "hotspot_authurl1",  	V_NONE         		 },
	{ "hotspot_authurl2",  	V_NONE         		 },
	{ "hotspot_timeout",  	V_RANGE(0,65536) 	 },
	{ "hotspot_kickout", 	V_RANGE(0,65536) 	 },
	{ "hotspot_whiteurl",  	V_NONE         		 },
	{ "hotspot_whiteip",  	V_NONE         		 },
	{ "hotspot_whitemac",  	V_NONE         		 },

	{ "inject_enable",   	V_01 	                 },
	{ "inject_jsurl",  	V_NONE         		 },

	{ "hijack_enable",   	V_01 	                 },
	{ "hijack_targeturl",  	V_NONE         		 },
	{ "hijack_hijackurl",  	V_NONE         		 },

	{ "pushing_enable",   	V_01 	                 },
	{ "pushing_interval",  	V_RANGE(0,65536)  	 },
	{ "pushing_url",  	V_NONE         		 },
