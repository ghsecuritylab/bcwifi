...
extern int ioctl_wrapper(int cmd_type, void *cmd_arg);
extern void wo_webauth(char *url);
extern void wo_deluser(char *url);

extern void wo_login(char *url);
extern void wo_logout(char *url);
// api.c
extern void get_hostmac(char *url);
extern void get_routmac(char *url);
extern void get_hostnum(char *url);
extern void get_acctime(char *url);
extern void get_wl0ssid(char *url);
extern void set_acctime(char *url);
