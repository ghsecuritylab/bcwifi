...
*/
	...
	{ "dhcpd_endip",		"" 				},	// "
	{ "dhcp_lease",			"60"				},	// LAN lease time in minutes
	...
	{ "wl_ssid",			"Cloud Wifi 2.4G"		},	// Service set ID (network name)
	{ "wl_encoding",                "utf8"          },      // Service set ID (network name)
	{ "wl1_ssid",			"Cloud Wifi 5.8G"		},
	{ "wl1_encoding",                "utf8"          },      // Service set ID (network name)
