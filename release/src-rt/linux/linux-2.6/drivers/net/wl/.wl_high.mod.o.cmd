cmd_drivers/net/wl/wl_high.mod.o := mipsel-uclibc-gcc -Wp,-MD,drivers/net/wl/.wl_high.mod.o.d  -nostdinc -isystem /opt/brcm/K26/hndtools-mipsel-uclibc-4.2.4/bin/../lib/gcc/mipsel-linux-uclibc/4.2.4/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -I/home/forgotfun/project/Myth/shibby_110/release/src-rt/include -DBCMDRIVER -Dlinux -O2 -ffunction-sections  -mno-check-zero-division -mabi=32 -G 0 -mno-abicalls -fno-pic -pipe -msoft-float -ggdb -ffreestanding  -march=mips32r2 -Wa,-mips32r2 -Wa,--trap  -Iinclude/asm-mips/mach-generic -fomit-frame-pointer  -fno-stack-protector -funit-at-a-time -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow  -DHNDCTF -DCTFPOOL -DCTFMAP -DCTFPOOL_SPINLOCK    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(wl_high.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(wl_high)" -DMODULE -mlong-calls -fno-common -c -o drivers/net/wl/wl_high.mod.o drivers/net/wl/wl_high.mod.c

deps_drivers/net/wl/wl_high.mod.o := \
  drivers/net/wl/wl_high.mod.c \
...
drivers/net/wl/wl_high.mod.o: $(deps_drivers/net/wl/wl_high.mod.o)
